...
public class StreamContext implements Closeable
{
    ...
    public XMLStreamReader newXmlStreamReader() throws FileNotFoundException, XMLStreamException
    {
    ...
    public XMLStreamWriter newXmlStreamWriter() throws IOException, XMLStreamException
    {
